...
public class TestAccountLogin {
    ...
    public void testAccountLogin() throws InterruptedException {
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.activity_login_et_email),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("hans.schmidt@email.com"), closeSoftKeyboard());

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.activity_login_et_password),
                        childAtPosition(
                                allOf(withId(R.id.layout_login),
                                        childAtPosition(
                                                withId(android.R.id.content),
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.activity_login_bt_login), withText("Login"),
                        childAtPosition(
                                allOf(withId(R.id.layout_login),
                                        childAtPosition(
                                                withId(android.R.id.content),

...
public class SystemEditActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(SystemEditActivity.this);
//        Places.initialize(SystemEditActivity.this, getString(R.string.google_api_key));
        ...
        mAddLocationBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Geocoder geocoder = new Geocoder(SystemEditActivity.this, Locale.getDefault());
...
//                        String name = mSelectedSysName.getString("KEY_SYSTEM_NAME");
                        while (m.find()) {
...
//                            Map<String, String> sysMap = new HashMap<>();
                            ...
                            hashMap.put(getString(R.string.hashmap_sysKey_2), sysKey);
                            hashMap.put(getString(R.string.hashmap_sysAddress_2), sysAddress);
...
//                            FirebaseDatabase.getInstance().getReference().child("").child("").setValue("");
                        ...
                        Intent intent = new Intent(SystemEditActivity.this, HomepageActivity.class);
//                        intent.putExtra("EXTRA_SYSTEM_KEY", sysKey);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        SettingsClient settingsClient = LocationServices.getSettingsClient(SystemEditActivity.this);
        Task<LocationSettingsResponse> task = settingsClient.checkLocationSettings(builder.build());

        task.addOnSuccessListener(SystemEditActivity.this, new OnSuccessListener<LocationSettingsResponse>() {
            @Override
        ...
        task.addOnFailureListener(SystemEditActivity.this, new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                if (e instanceof ResolvableApiException) {
                    ResolvableApiException resolvable = (ResolvableApiException) e;
                    try {
                        resolvable.startResolutionForResult(SystemEditActivity.this, 51);
                ...
                .addOnCompleteListener(new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SystemEditActivity.this, "unable to get last location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }

...
public class PermissionsActivity extends AppCompatActivity {
    ...
    private Button mGrant_bt;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_permissions_map);
        ...
        mGrant_bt = findViewById(R.id.grant_perm_map_bt);

        mGrant_bt.setOnClickListener(new View.OnClickListener() {
            @Override
